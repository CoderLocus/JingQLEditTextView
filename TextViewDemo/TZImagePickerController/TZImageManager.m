...
- (NSString *)getBytesFromDataLength:(NSInteger)dataLength {
    ...
    if (dataLength >= 0.1 * (1024 * 1024)) {
        ...
        bytes = [NSString stringWithFormat:@"%0.0fK",dataLength/10.0];
    } else {
...
- (void)getPostImageWithAlbumModel:(TZAlbumModel *)model completion:(void (^)(UIImage *))completion {
    if (iOS8Later) {
        ...
        [[TZImageManager manager] getPhotoWithAsset:asset photoWidth:800 completion:^(UIImage *photo, NSDictionary *info, BOOL isDegraded) {
